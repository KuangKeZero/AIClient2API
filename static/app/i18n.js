...
const translations = {
    'zh-CN': {
        ...
        'oauth.codex.duplicateCredentials': '重复凭据 - 已存在相同的 {field}',
        'oauth.codex.duplicateFieldRefreshToken': 'refresh_token',
        'oauth.codex.duplicateFieldAccessToken': 'access_token',
        'oauth.codex.duplicateFieldCredential': '凭据',
        ...
        'config.advanced.requestBodyMaxBytes': 'API 请求体上限(字节)',
        'config.advanced.requestBodyMaxBytesNote': '默认 50MB (52428800 字节)，用于聊天、Responses 和生图 JSON 请求。',
        ...
        'usage.syncProviderPoolLoading': '正在同步账号池...',
        'usage.syncProviderPoolSuccess': '同步完成：新增 {added} 个，已存在 {existing} 个，跳过禁用 {skipped} 个',
        ...
        'usage.pending.title': '待恢复账号',
        'usage.pending.count': '{count} 个待恢复',
        'usage.pending.usage': '预计 {used}% / 阈值 {threshold}%',
        'usage.pending.recoveryAt': '恢复时间: {time}',
        'usage.pending.recoveryUnknown': '待确认',
        'usage.pending.refresh': '验证恢复',
        'usage.pending.verifyAll': '统一验证',
        'usage.pending.page': '第 {page} / {pages} 页',
        'usage.pending.pageSize': '每页',
        'usage.pending.prevPage': '上一页',
        'usage.pending.nextPage': '下一页',
        'usage.pending.collapse': '收起待恢复账号',
        'usage.pending.expand': '展开待恢复账号',
        'usage.pending.confidence': '置信度 {value}%',
        'usage.pending.recent401': '401: {count}',
        'usage.pending.recent429': '429: {count}',
        'usage.pending.unnamed': '未命名账号',
        'usage.pending.reason.cooldown': '冷却中',
        'usage.pending.reason.estimated_threshold': '估算达到阈值',
        'usage.pending.reason.waiting_reset': '等待额度刷新',
        'usage.pending.reason.awaiting_reset_refresh': '等待刷新确认',
        'usage.pending.reason.refresh_pending': '正在验证',
        'usage.pending.reason.low_frequency_verify': '低频验证中',
        'usage.pending.reason.unknown': '待恢复',
    ...
    'en-US': {
        ...
        'oauth.codex.duplicateCredentials': 'Duplicate credential - same {field} already exists',
        'oauth.codex.duplicateFieldRefreshToken': 'refresh_token',
        'oauth.codex.duplicateFieldAccessToken': 'access_token',
        'oauth.codex.duplicateFieldCredential': 'credential',
        ...
        'config.advanced.requestBodyMaxBytes': 'API Request Body Limit (bytes)',
        'config.advanced.requestBodyMaxBytesNote': 'Default 50MB (52428800 bytes), used for chat, Responses, and image JSON requests.',
        ...
        'usage.syncProviderPool': 'Sync Provider Pool',
        ...
        'usage.syncProviderPoolLoading': 'Syncing provider pool...',
        'usage.syncProviderPoolSuccess': 'Sync complete: added {added}, existing {existing}, skipped disabled {skipped}',
        ...
        'usage.pending.title': 'Pending Restore Accounts',
        'usage.pending.count': '{count} pending',
        'usage.pending.usage': 'Est. {used}% / threshold {threshold}%',
        'usage.pending.recoveryAt': 'Restore at: {time}',
        'usage.pending.recoveryUnknown': 'To be confirmed',
        'usage.pending.refresh': 'Verify recovery',
        'usage.pending.verifyAll': 'Verify All',
        'usage.pending.page': 'Page {page} / {pages}',
        'usage.pending.pageSize': 'Per page',
        'usage.pending.prevPage': 'Previous page',
        'usage.pending.nextPage': 'Next page',
        'usage.pending.collapse': 'Collapse pending accounts',
        'usage.pending.expand': 'Expand pending accounts',
        'usage.pending.confidence': 'Confidence {value}%',
        'usage.pending.recent401': '401: {count}',
        'usage.pending.recent429': '429: {count}',
        'usage.pending.unnamed': 'Unnamed account',
        'usage.pending.reason.cooldown': 'Cooling down',
        'usage.pending.reason.estimated_threshold': 'Estimate reached threshold',
        'usage.pending.reason.waiting_reset': 'Waiting for quota reset',
        'usage.pending.reason.awaiting_reset_refresh': 'Waiting for refresh check',
        'usage.pending.reason.refresh_pending': 'Verifying',
        'usage.pending.reason.low_frequency_verify': 'Low-frequency verification',
        'usage.pending.reason.unknown': 'Pending restore',
